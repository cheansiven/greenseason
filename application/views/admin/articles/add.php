  ...
  <div class="page-full-width cf">
    <div> <!-- class="side-content fr" -->
        ...
        <div class="content-module-main cf"> 
            <?php echo form_open_multipart('admin/articles/store', 'id="articleForm" class="form-horizontal" title="articleForm"'); ?>
                ...
                <?php echo validation_errors(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo form_input('title','', 'id="title" class="round form-control default-width-input" autofocus'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo form_input('sub_title','', 'id="sub_title" class="round form-control default-width-input" autofocus'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div id="category" class="col-sm-10">
                            <?php
                                ...
                                foreach ($categories as $category)
                                {
                                    ...
                                    $option_category[$category['id']] = $type.' '.$category['name'];
                                }

                                echo form_dropdown('category_id', $option_category, "", 'id="category_id" class="round form-control"');
                            ?>
