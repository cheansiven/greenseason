...
<head>
	<meta charset="utf-8">
	<title>Tours Services Management - New service</title>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="#" class="active-tab dashboard-tab">Add new service</a></li>
			</ul> 
            <!-- end tabs -->
		...
		<div class="page-full-width cf">
			...
			<div> <!-- class="side-content fr" -->
				...
				<div class="content-module">
					...
					<?php echo form_open_multipart('admin/services/store', 'id="serviceForm" name="serviceForm"'); ?>
