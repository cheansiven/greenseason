...
<div id="header-with-tabs">
    <div class="page-full-width cf">
        <ul id="tabs" class="fl">
            <li><a href="<?php echo site_url("admin/flight_categories/");?>" class="dashboard-tab">Dashboard</a></li>
            <li><a href="" onclick="return false;" class="active-tab">Add new category</a></li>
        </ul>
        <!-- end tabs -->
    ...
    <div class="page-full-width cf">
        <div class="content-module">
            ...
            <div class="content-module-main">
                <div class="content-module-main">
                    <!--<h1>FLIGHT</h1>-->
                    <form id="flight" action="<?= base_url()."admin/flight_categories/store"; ?>" method="post" enctype="multipart/form-data">

                        <div class="equalHeight pull-left">
                            <div class="destination">
                                <p>MAIN DESTINATION</p>
                                <input type="text" name="flight_destination" size="50" />
                            </div>
                        ...
                        <div class="equalHeight pull-right">
                            ...
                            <div class="page-title">
                                <p>PAGE TITLE</p>
                                <input type="text" name="page_title" size="50" />
                            </div>
                            <div class="meta-destination">
                                <p>META DESCRIPTION</p>
                                <input type="text" name="meta_description" size="50" />
                            </div>
                            <div class="meta-keywords">
                                <p>META KEYWORDS</p>
                                <input type="text" name="meta_keywords" size="50" />
                            </div><br />
