...
<head>
<meta charset="utf-8">
<title>Gallery Category Management - Edit tour</title>
...
<div id="header-with-tabs">
	<div class="page-full-width cf">
    	<ul id="tabs" class="fl">
      		...
      		<li><a href="#" class="active-tab dashboard-tab">Edit gallery category meta data</a></li>
    	</ul>
		...
		<div class="page-full-width cf">
			...
			<div> <!-- class="side-content fr" -->
				...
				<div class="content-module">
					...
					<?php echo form_open_multipart('admin/gallery_categories/updateMeta'); ?>
								...
								<fieldset>
									...
									<p>
                                        ...
                                        <?php
										  ...
										  echo form_input('meta_title',$gallery->meta_title, 'id="meta_title" class="round default-width-input" autofocus');
                                     ...
                                     <p>
                                        ...
                                        <?php
										  ...
										  echo form_input('url',$gallery->url, 'id="url" class="round default-width-input" autofocus');
                                    ...
                                    <p>
                                        ...
                                        <?php
										  ...
										  echo form_input('meta_keyword',$gallery->meta_keyword, 'id="meta_keyword" class="round default-width-input" autofocus');
                                    ...
                                    <p>
                                        ...
                                        <?php
										  ...
										  echo form_input('meta_description',$gallery->meta_description, 'id="meta_description" class="round" style="width:1000px;" autofocus');
										  
									    ?>
									</p>
									<?php 
									echo form_hidden('id',$gallery->id, set_value('id'));
